...
# Home route for showing the front page of web page
@app.route('/')
def index():
    return render_template('index.html')

#  when user searches the movie so that it can show results using search_result.html 
...
# Movie details route for diplaying movies
...
# Add movie to favorites for adding fav movies 
